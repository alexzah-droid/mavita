...
| `ROADMAP.md` | план развития по фазам Ф0–Ф5, статусы | актуален |
...
| `docs/specs/` | спецификации фич (создаются по шаблону) | пусто |
| `docs/environments.md` | стенды, SSH, VPS, запреты | актуален |
| `docs/operations.md` | runbook деплоя, backup, откат | **не создан** (ждёт деплоя) |
...
| Файл | Содержит |
| --- | --- |
| `index.html` | бандлированное КП — не редактировать |
| `Мавита - четыре направления (один файл).html` | HTML-презентация четырёх направлений |
| `mavita_kp.pdf` | PDF-версия КП |
