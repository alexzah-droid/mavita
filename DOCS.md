...
| --- | --- | --- |
| `PROJECT_CORE.md` | контракт агента, инварианты, статус фаз | актуален (2026-07-02) |
| `CLAUDE.md` | вход для агента: стек, команды, архитектура кратко | актуален (2026-07-02) |
| `DOCS.md` | этот реестр | актуален |
| `ROADMAP.md` | план развития по фазам Ф0–Ф5, статусы (**источник статуса**) | актуален (2026-07-02) |
| `TESTING_PLAN.md` | трассировка тестов по инвариантам и требованиям | актуален (2026-07-02) |
| `architecture.md` | стек, схема БД, флоу оплаты, деплой | актуален (2026-07-02) |
| `architecture-components.md` | sequence/граф компонентов флоу оплаты | актуален (2026-07-02) |
...
| Документ | Содержит | Статус |
| --- | --- | --- |
| `docs/business-requirements.md` | каталог бизнес-требований и функций (`FR-*`/`BR-*`) — основа трассировки и справки | актуален (2026-07-02) |
| `docs/decisions.md` | журнал архитектурных и продуктовых решений | актуален (2026-07-02) |
| `docs/lessons-learned.md` | выученные уроки и обязательный preflight для внешних интеграций | актуален (2026-06-21) |
| `docs/tech-debt.md` | активный backlog техдолга с приоритетами и сложностью | актуален (2026-07-02) |
| `docs/competitor-ideas-silva.md` | идеи с silvacandle.ru: отзывы, FAQ, Telegram, лимитированные выпуски — вход для roadmap-планирования | planning input (2026-06-30) |
...
| `docs/specs/done/yandex-metrika.md` | Яндекс.Метрика `110274888`: production-счетчик, SPA-hit, privacy update; события воронки `add_to_cart`/`begin_checkout`/`purchase`; `/admin*` исключён, `/order` трекается обезличенно без вебвизора | ✅ на проде (2026-07-01, дополнено 2026-07-02) |
