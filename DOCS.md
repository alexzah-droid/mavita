...
| `docs/specs/admin-orders.md` | Ф4-компонент: заказы, ПВЗ СДЭК, платная доставка, исполнение и безопасная отмена | актуален; ожидает Пауза 2 на CDEK-интеграцию (2026-06-20) |
