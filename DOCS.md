...
| `ROADMAP.md` | план развития по фазам Ф0–Ф5, статусы (**источник статуса**) | актуален (2026-06-30) |
...
| `docs/tech-debt.md` | активный backlog техдолга с приоритетами и сложностью | актуален (2026-06-30) |
...
| `docs/specs/done/yandex-metrika.md` | Яндекс.Метрика `110274888`: production-счетчик, SPA-hit, privacy update, исключения `/admin*` и `/order*` | ✅ реализована и развернута на проде (2026-07-01) |
