...
| Ф4 | Админ-панель | ✅ | К1–К3 на проде (миграции `001`–`022` подтверждены 2026-07-09); контур автоотправки СДЭК ждёт подтверждения первым боевым заказом |
...
- ✅ Миграции `001`–`022` применены на проде (`022` и значения веса чистого
  воска подтверждены 2026-07-09).
...
10. **Усилить карточки товара контентом.**
   - ✅ Инфраструктура характеристик готова (2026-07-08, миграции `020`/`022`):
     вес изделия, вес чистого воска, время горения, состав воска, фитиль — поля
     в админке, блок на карточке, пустые скрываются. Плюс строка стоимости
     доставки на карточке.
