...
export type AdminOrderDetail = Omit<AdminOrderListItem, 'customerPhoneMasked'> & { customerPhone: string | null; customerComment: string | null; invId: number | null; itemsKopecks: number; deliveryKopecks: number; deliveryCarrier: 'cdek' | null; deliveryMethod: 'cdek_pickup' | null; pickupPoint: { code: string; city: string; name: string; address: string } | null; trackingNumber: string | null; cdekOrderUuid: string | null; cdekNumber: string | null; cdekWaybillUrl: string | null; cdekBarcodeUrl: string | null; cdekError: string | null; items: { productName: string; priceKopecks: number; quantity: number }[]; adminEvents: { id: number; eventType: 'cancelled' | 'fulfillment_transition' | 'cdek_status_update'; reason: string | null; fromFulfillmentStatus: FulfillmentStatus; toFulfillmentStatus: FulfillmentStatus; trackingNumber: string | null; actorLoginAt: number; createdAt: string }[] }
...
type DetailRow = Row & { customer_comment: string | null; inv_id: number | null; items_kopecks: number | string; delivery_kopecks: number | string; delivery_carrier: 'cdek' | null; delivery_method: 'cdek_pickup' | null; pickup_point_code: string | null; pickup_point_city: string | null; pickup_point_name: string | null; pickup_point_address: string | null; tracking_number: string | null; cdek_order_uuid: string | null; cdek_number: string | null; cdek_waybill_url: string | null; cdek_barcode_url: string | null; cdek_error: string | null }
