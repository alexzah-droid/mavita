...
describe('validateProductInput', () => {
  ...
  it('принимает публичные характеристики свечи и различает null/отсутствие', () => {
    expect(validateProductInput({ ...product, waxWeight: ' 120 г ', burnTimeHours: 40, wax: ' 100% соевый воск ', wick: 'Хлопковый' }, 'create').value)
      .toMatchObject({ waxWeight: '120 г', burnTimeHours: 40, wax: '100% соевый воск', wick: 'Хлопковый' })
    expect(validateProductInput({ ...product, waxWeight: null, burnTimeHours: null, wax: null, wick: null }, 'create').value)
      .toMatchObject({ waxWeight: null, burnTimeHours: null, wax: null, wick: null })
  ...
  it('отвергает невалидные характеристики свечи', () => {
    ...
    expect(validateProductInput({ ...product, waxWeight: 'x'.repeat(201) }, 'create').errors).not.toHaveLength(0)
