// Шифрование секретов перевозчиков (ключи API СДЭК/Ozon) для хранения в БД.
...
//   при расшифровке, поэтому ozon_api_key_enc нельзя подставить в cdek_client_secret_enc.
//
