      ...
      <Script
        ...
        dangerouslySetInnerHTML={{
          __html: `
            ...
            ym(${YANDEX_METRIKA_ID}, 'init', {defer:true, ssr:true, webvisor:true, clickmap:true, ecommerce:"dataLayer", accurateTrackBounce:true, trackLinks:true});
            ym(${YANDEX_METRIKA_ID}, 'hit', location.href, {referer: document.referrer, title: document.title});
          `,
        }}
      />
      <noscript>
